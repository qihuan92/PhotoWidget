package com.qihuan.photowidget.common.blur;
...
public class BlurLayout extends FrameLayout {
    ...
    public BlurLayout(Context context, AttributeSet attrs) {
        ...
        try {
            mDownscaleFactor = a.getFloat(R.styleable.BlurLayout_blur_downscaleFactor, DEFAULT_DOWNSCALE_FACTOR);
            mBlurRadius = a.getInteger(R.styleable.BlurLayout_blur_radius, DEFAULT_BLUR_RADIUS);
            mFPS = a.getInteger(R.styleable.BlurLayout_blur_fps, DEFAULT_FPS);
            mAlpha = a.getDimension(R.styleable.BlurLayout_blur_alpha, DEFAULT_ALPHA);
            mBlurMaskColor = a.getColor(R.styleable.BlurLayout_blur_mask_color, ContextCompat.getColor(context, R.color.blur_mask));
        } finally {
            a.recycle();
        }
    ...
    private Bitmap blur() {
        ...
        canvas.drawColor(mBlurMaskColor);
     ...
     */
    private Bitmap getDownscaledBitmapForView(View view, Rect crop, float downscaleFactor) throws IllegalArgumentException, NullPointerException {
